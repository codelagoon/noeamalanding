  ...
  return (
    <div className="space-y-4">
            ...
            <div key={group}>
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-3">
                  ...
                  {isReference && (
                    <span className="px-1.5 py-0.5 text-[10px] font-mono font-semibold bg-[#6EA8FE]/10 text-[#6EA8FE] rounded">
                      reference
                    </span>
                  )}
                  {metric && (
      ...
      <div className="flex flex-wrap items-center gap-x-6 gap-y-1 mt-2">
        <p className="font-mono text-xs text-gray-400">
          <span className="inline-block w-3 h-3 rounded-sm bg-[#6EA8FE] mr-1.5 align-middle" />
          Reference group
        </p>
        <p className="font-mono text-xs text-gray-400">
